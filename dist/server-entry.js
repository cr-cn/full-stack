...
var AppState = (_class = function () {
  function AppState() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { count: 0, name: 'Ray' },
        count = _ref.count,
        name = _ref.name;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', '/Users/xujianwei/sites/full-stack/client/store/app-state.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/xujianwei/sites/full-stack/client/server-entry.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(App, 'App', '/Users/xujianwei/sites/full-stack/client/views/App.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/xujianwei/sites/full-stack/client/config/router.jsx');
}();
...
var TopicList = (_dec = (0, _mobxReact.inject)('appState'), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  function TopicList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.changeName = function () {
      var _this2;

      return (_this2 = _this).__changeName__REACT_HOT_LOADER__.apply(_this2, arguments);
  ...
  TopicList.prototype.__changeName__REACT_HOT_LOADER__ = function __changeName__REACT_HOT_LOADER__(event) {
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicList, 'TopicList', '/Users/xujianwei/sites/full-stack/client/views/topic-list/index.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicDetail, 'TopicDetail', '/Users/xujianwei/sites/full-stack/client/views/topic-detail/index.jsx');
}();
...
var TestApi = function (_Component) {
  ...
  TestApi.prototype.login = function login() {
    _axios2.default.post('/api/user/login', { accessToken: '17a0cdcd-2639-469f-9d45-bd68bb1f7044' }).then(function (resp) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TestApi, 'TestApi', '/Users/xujianwei/sites/full-stack/client/views/test/api-test.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', '/Users/xujianwei/sites/full-stack/client/store/store.js');

  __REACT_HOT_LOADER__.register(createStoreMap, 'createStoreMap', '/Users/xujianwei/sites/full-stack/client/store/store.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/xujianwei/sites/full-stack/client/store/store.js');
}();
